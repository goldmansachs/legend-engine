...
public class Test_Relational_Databricks_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // bitShift: Databricks does not raise the >62-bit guard error and does not clamp the shift
            one("meta::pure::functions::math::tests::bitShiftLeft::testBitShiftLeft_MoreThan62Bits_Function_1__Boolean_1_", "Unsupported number of bits to shift - max bits allowed is 62", AdapterQualifier.assertErrorMismatch),
            one("meta::pure::functions::math::tests::bitShiftLeft::testBitShiftLeft_UpTo62Bits_Function_1__Boolean_1_", "actual:   70368744177664", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::math::tests::bitShiftRight::testBitShiftRight_MoreThan62Bits_Function_1__Boolean_1_", "Unsupported number of bits to shift - max bits allowed is 62", AdapterQualifier.assertErrorMismatch),

            // percentile over a generated numeric array: percentile_cont rejects ARRAY<BIGINT>
            one("meta::pure::functions::math::tests::percentile::testPercentile_Function_1__Boolean_1_", "The first parameter requires the (\"NUMERIC\"", AdapterQualifier.unsupportedFeature)
    );
