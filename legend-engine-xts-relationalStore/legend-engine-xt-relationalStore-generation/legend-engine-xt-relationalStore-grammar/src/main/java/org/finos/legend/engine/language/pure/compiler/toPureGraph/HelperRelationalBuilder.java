...
public class HelperRelationalBuilder
{
    ...
    public static Relation getRelation(Database db, final String _schema, final String _table, TablePtr tableptr, CompileContext context, SourceInformation sourceInformation)
    {
        ...
        if (table == null)
        {
            if (tableptr != null && context != null && context.pureModel != null && context.pureModel.compilationParameters != null)
            {
                TablePtr mappedTablePtr = context.pureModel.compilationParameters.getTableMappings().get(tableptr);
    ...
    private static void validateSchemaExists(Database db, String _schema, TablePtr tableptr, CompileContext context, SourceInformation sourceInformation)
    {
        ...
        if (tableptr != null && context != null && context.pureModel != null && context.pureModel.compilationParameters != null)
        {
            TablePtr ptr = context.pureModel.compilationParameters.getTableMappings().get(tableptr);
