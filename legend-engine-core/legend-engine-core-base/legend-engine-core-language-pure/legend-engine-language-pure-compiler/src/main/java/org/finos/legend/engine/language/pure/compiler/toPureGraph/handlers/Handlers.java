...
public class Handlers
{
    ...
    private void registerStrings()
    {
        ...
        register("meta::pure::functions::string::generation::uuid__String_1_", false, ps -> res("String", "one"));
    }
...
//-------------------------------------------------------------------------------------------------
    ...
    private Map<String, Dispatch> buildDispatch()
    {
        ...
        map.put("meta::pure::functions::string::generation::uuid__String_1_", (List<ValueSpecification> ps) -> ps.size() == 0);
