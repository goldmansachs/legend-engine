...
public class Handlers
{
    ...
    {
        if (m._lowerBound()._value() >= 1 && (m._upperBound()._value() == null || (m._upperBound()._value() != null && m._upperBound()._value() >= 1)))
        {
            return pm.getMultiplicity("one");
        }
        return pm.getMultiplicity("zeroone");
    }
