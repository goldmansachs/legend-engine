...
//                ps -> Lists.fixedSize.of(ps.get(0)._genericType()),
        ...
        register(h("meta::pure::mapping::getSourceEnumValues_Mapping_1__Enumeration_1__T_MANY_", "getSourceEnumValues", false, ps -> res(ps.get(1)._genericType()._typeArguments().getFirst(), "zeroMany"), ps -> ps.size() == 2 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_mapping_Mapping"))));
        register(h("meta::pure::mapping::getSourceEnumValuesByName_Mapping_1__Enumeration_1__String_1__T_MANY_", "getSourceEnumValuesByName", false, ps -> res(ps.get(1)._genericType()._typeArguments().getFirst(), "zeroMany"), ps -> ps.size() == 3 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_mapping_Mapping")) && typeOne(ps.get(2), "String")));
