...
public class GenerateDiffTestBase
{
    ...
    protected String diff(String newEntities, String newDependencies, String oldEntities, String oldDependencies, String versions)
    {
        return new GenerateDiff(pure(newEntities), pure(newDependencies), pure(oldEntities), pure(oldDependencies)).execute(versions, null, null, null);
    }
