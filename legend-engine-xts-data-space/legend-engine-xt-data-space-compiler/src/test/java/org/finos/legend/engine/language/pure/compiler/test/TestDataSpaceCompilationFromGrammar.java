...
public class TestDataSpaceCompilationFromGrammar extends TestCompilationFromGrammar.TestCompilationFromGrammarTestSuite
{
    ...
    public void testDataSpaceInfoProfileInvalidStereotype()
    {
        test("###Mapping\n" +
                ...
                "  ];\n" +
                "  defaultExecutionContext: 'Context 1';\n" +
                "}\n", "COMPILATION error at [17:13-72]: Can't find stereotype 'NonExistent' in profile 'meta::pure::metamodel::dataSpace::profiles::DataSpaceInfo'");
    }
    ...
    public void testDataSpaceInfoProfileInvalidTag()
    {
        test("###Mapping\n" +
                ...
                "  ];\n" +
                "  defaultExecutionContext: 'Context 1';\n" +
                "}\n", "COMPILATION error at [17:13-72]: Can't find tag 'nonExistentTag' in profile 'meta::pure::metamodel::dataSpace::profiles::DataSpaceInfo'");
    }
